...
print "Content-type: text/html\n\n";
print "<html><head><title>HELP TICKET AID OUTPUT</title></head>\n";
print "<body><FONT SIZE = 5><b>LIFE SAFETY SYSTEMS<br>HELP TICKET AID OUTPUT</b></FONT><FONT SIZE = 2 color = red>\&nbsp\;\&nbsp\;<b>$ver</b></font><br><br>\n";
...
print "<br><br><li><a href=https://help.unc.edu/help/olhr/ target=_blank>Help Web Site</a>\n";
